...
var _ opxdm.WithdrawalMessage = (*Withdrawal)(nil)
...
func (w *Withdrawal) Encode() ([]byte, error) {
	args := abi.Arguments{
		{Name: "nonce", Type: opxdm.Uint256Type},
		{Name: "sender", Type: opxdm.AddressType},
		{Name: "target", Type: opxdm.AddressType},
		{Name: "value", Type: opxdm.Uint256Type},
		{Name: "gasLimit", Type: opxdm.Uint256Type},
		{Name: "data", Type: opxdm.BytesType},
	}
