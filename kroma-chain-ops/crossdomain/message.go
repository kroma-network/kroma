...
func (c *CrossDomainMessage) Encode() ([]byte, error) {
	...
	switch version {
	case 0:
		return EncodeCrossDomainMessageV0(c.Nonce, c.Sender, c.Target, c.Value, c.GasLimit, c.Data)
	case 1:
...
func (c *CrossDomainMessage) Hash() (common.Hash, error) {
	...
	switch version {
	case 0:
		return HashCrossDomainMessageV0(c.Nonce, c.Sender, c.Target, c.Value, c.GasLimit, c.Data)
	case 1:
...
// HashV1 forces using the V0 hash even if its a legacy hash. This is used
