...
// KanvasGeth is an actor that functions as a l2 kanvas-geth node
// It provides useful functions for advancing and querying the chain
type KanvasGeth struct {
	node          *gn.Node
...
func NewKanvasGeth(t *testing.T, ctx context.Context, cfg *SystemConfig) (*KanvasGeth, error) {
...
func (d *KanvasGeth) AddL2Block(ctx context.Context, txs ...*types.Transaction) (*eth.ExecutionPayload, error) {
...
func (d *KanvasGeth) StartBlockBuilding(ctx context.Context, attrs *eth.PayloadAttributes) (*eth.ForkchoiceUpdatedResult, error) {
	fc := eth.ForkchoiceState{
...
func (d *KanvasGeth) CreatePayloadAttributes(txs ...*types.Transaction) (*eth.PayloadAttributes, error) {
