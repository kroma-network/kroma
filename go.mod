...
replace github.com/ethereum-optimism/optimism v1.7.0 => ./

replace github.com/ethereum/go-ethereum v1.13.8 => github.com/kroma-network/go-ethereum v1.101308.3-0.20240321085036-a52ae1ce546d
