...
import {
    IKanvasMintableERC20
} from "../universal/IKanvasMintableERC20.sol";
import { Bridge_Initializer } from "./CommonTest.t.sol";

contract KanvasMintableERC20_Test is Bridge_Initializer {
    ...
    function test_mint_notBridge_reverts() external {
        // NOT the bridge
        vm.expectRevert("KanvasMintableERC20: only bridge can mint and burn");
    ...
    function test_erc165_supportsInterface_succeeds() external {
        ...
        assertEq(iface2, type(IKanvasMintableERC20).interfaceId);
