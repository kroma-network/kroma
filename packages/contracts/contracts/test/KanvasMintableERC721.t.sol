...
contract KanvasMintableERC721_Test is ERC721Bridge_Initializer {
    ERC721 internal L1Token;
    KanvasMintableERC721 internal L2Token;
    ...
    function setUp() public override {
        ...
        L2Token = new KanvasMintableERC721(
            address(L2Bridge),
            1,
            address(L1Token),
            "L2Token",
    ...
    function test_safeMint_notBridge_reverts() external {
        ...
        vm.expectRevert("KanvasMintableERC721: only bridge can call this function");
