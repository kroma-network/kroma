...
contract MintManagerTest is CommonTest {
    ...
    address constant MINT_TOKEN_CALLER = 0xdEaDDEadDEadDeaDDeadDeaDDEADDEADdEAd0070;
    ...
    function test_mint_notMintCaller_reverts() external {
        vm.expectRevert("MintManager: only the mint caller is accepted");
