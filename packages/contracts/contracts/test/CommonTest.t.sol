...
contract Colosseum_Initializer is Portal_Initializer {
    ...
    function setUp() public virtual override {
        ...
        zkVerifierImpl = new ZKVerifier({
            _hashScalar: 8569438214477174332549560860260523060356109359900484321906627125223297137925,
            _m56Px: 21497446564390348422441349451078208622945112491569931676612726194258212119314,
            _m56Py: 348901966417095718636837714739718192984222473734838608401173851728829413314
        });
        vm.prank(multisig);
