...
contract ZKVerifier is ISemver {
    ...
    function get_wx_wg(
        ...
        (t0, t1) = (
            ecc_mul_add(
                180766510818100606876079393411341924795045473557678316715004877463205110600,
                8678620674269670492079265460220849328759642083222840696308390372332250063906,
                m[78],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                12326943525459083232009435488022301174834233469827710052315836316414079509275,
                11296102370327324837596976186521392711866731582086644691310790663868933139668,
                m[77],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                21492546063699078909771354881983686109460058928296140130614976882166648809222,
                3988207309706888334539661541661186239986314368839441388848365547870489648159,
                m[76],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                8964002332277089993835063760141066694892070973791791521473177877134704932813,
                19417099941485310176260017136199085245892178436232736634173467555137047644270,
                m[75],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                6995068134091368588466342441860649252397594516754305602681877211887396716731,
                4635276699389983914463505433595021407599191731084192485300382157757341613028,
                m[74],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                9488629160908640477647238843962134221422070922713578709479039545777735012600,
                18182877024371810296487801214067211908332964619668186745953922271456276377564,
                m[73],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                8126158668369310221078647985863298005172344131927766400609846191426037562098,
                6155277266304223920913347596422237678612986765222632693444285661220329908729,
                m[71],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                19376702576522356316068109014621566864528620753262191125462794305060279615182,
                10641421387638208604206162203829353665953012405129850225695377984390553925439,
                m[69],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                18003329062503201671458520533792589624850661029024587983226330295578817515934,
                15672400829546725626958152128335518675501598202579809998849262981444979182539,
                m[67],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                17412164362932767750613204872882107217716149442245394177248870515181152618054,
                5913100932333828162270314745834442932732537777971191992374372568194697405332,
                m[65],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                21226206786605014389367418832917188232261781947022699424386461700735983404112,
                18987438310057665644585569883949857318536985533146768863087080343407043817280,
                m[64],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                5425455908429499332875983646457051541851651919709511975892682118028912887805,
                9987843168038215948298474408413622980988050164122981549391070715855371642829,
                m[63],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                5863340162479603283990404911179019744773222469055972618624702934333754848511,
                14974727849451490600219493013871162296749138130224573057869821337384056536535,
                m[62],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                17714768147802532186884407711358468407966687721933250480611839518809431187884,
                15347738112048076304837417227643161463732285400302849770969646681766434979793,
                m[61],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                8855928657346728686651848005631334774260131549242379953032626607433713627231,
                5583890817663496738871219300378771697236224303250536816748937132729098647357,
                m[60],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                5189332675310598937156652579772859851232135390312205538717171295996780418586,
                20008442801866785722766450912929802537029294485715762257590626777043088832531,
                m[59],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                20537801472213802867768927195586616285892067557673262770579506559674247525059,
                2107206166045136659630095796091717975862385730420517816287001239673984785954,
                m[58],
                t0,
                t1
            )
        ...
        (t0, t1) = (
            ecc_mul_add(
                14998907457488903455596437056775868079943527104350332612989662501994998558936,
                21066654314837786914707204260044472017426954284124637095975156004055550267428,
                m[57],
                t0,
                t1
            )
