 ...
 * @custom:proxied
 * @title KanvasPortal
 * @notice The KanvasPortal is a low-level contract responsible for passing messages between L1
 *         and L2. Messages sent directly to the KanvasPortal have no form of replayability.
 *         Users are encouraged to use the L1CrossDomainMessenger for a higher-level interface.
 */
contract KanvasPortal is Initializable, ResourceMetering, Semver {
    /**
    ...
    modifier whenNotPaused() {
        require(paused == false, "KanvasPortal: paused");
        _;
    }
    ...
    function pause() external {
        require(msg.sender == GUARDIAN, "KanvasPortal: only guardian can pause");
        paused = true;
    ...
    function unpause() external {
        require(msg.sender == GUARDIAN, "KanvasPortal: only guardian can unpause");
        paused = false;
    ...
    function proveWithdrawalTransaction(
        ...
        require(
            ...
            "KanvasPortal: you cannot send messages to the portal contract"
        );
        ...
        require(
            ...
            "KanvasPortal: invalid output root proof"
        );
        ...
        require(
            ...
            "KanvasPortal: withdrawal hash has already been proven"
        );
        ...
        require(
            ...
            "KanvasPortal: invalid withdrawal inclusion proof"
        );
        ...
        whenNotPaused
    {
        ...
        require(
            l2Sender == Constants.DEFAULT_L2_SENDER,
            "KanvasPortal: can only trigger one withdrawal per transaction"
        );
        ...
        require(
            provenWithdrawal.timestamp != 0,
            "KanvasPortal: withdrawal has not been proven yet"
        );
        ...
        require(
            ...
            "KanvasPortal: proven withdrawal finalization period has not elapsed"
        );
        ...
        require(
            ...
            "KanvasPortal: checkpoint output finalization period has not elapsed"
        );

        // Check that this withdrawal has not already been finalized, this is replay protection.
        require(
            finalizedWithdrawals[withdrawalHash] == false,
            "KanvasPortal: withdrawal has already been finalized"
        );
        ...
        if (success == false && tx.origin == Constants.ESTIMATION_ADDRESS) {
            revert("KanvasPortal: withdrawal failed");
        }
    }
    ...
    function depositTransaction(
        ...
        if (_isCreation) {
            require(
                _to == address(0),
                "KanvasPortal: must send to address(0) when creating a contract"
            );
        }

        // Prevent depositing transactions that have too small of a gas limit.
        require(_gasLimit >= 21_000, "KanvasPortal: gas limit must cover instrinsic gas cost");
