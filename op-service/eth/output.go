...
type OutputResponse struct {
	...
	// [Kroma: START]
	NextBlockRef     L2BlockRef        `json:"nextBlockRef,omitempty"`
	PublicInputProof *PublicInputProof `json:"publicInputProof,omitempty"`
	// [Kroma: END]
}
...
func UnmarshalOutput(data []byte) (Output, error) {
	...
	case OutputVersionV0:
		// [Kroma: START]
		if len(data) == 160 {
			return unmarshalKromaOutputV0(data)
		}
		// [Kroma: END]
