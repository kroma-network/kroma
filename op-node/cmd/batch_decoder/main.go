		...
		},
		{
			...
			Flags: []cli.Flag{
				...
				&cli.Uint64Flag{
					Name:  "l2-chain-id",
					Value: 255,
					Usage: "L2 chain id for span batch derivation. Default value from Kroma mainnet.",
				},
				&cli.Uint64Flag{
					Name:  "l2-genesis-timestamp",
					Value: 1693880387,
					Usage: "L2 genesis time for span batch derivation. Default value from Kroma mainnet.",
				},
				&cli.Uint64Flag{
					Name:  "l2-block-time",
					Value: 2,
					Usage: "L2 block time for span batch derivation. Default value from Kroma mainnet.",
				},
				&cli.StringFlag{
					Name:  "inbox",
					Value: "0xff00000000000000000000000000000000000255",
					Usage: "Batch Inbox Address. Default value from Kroma mainnet.",
				},
				// [Kroma: END]
			},
			Action: func(cliCtx *cli.Context) error {
