...
func TestMPTNetworkTransactions(t *testing.T) {
	...
	require.Equal(t, hexutil.Bytes(baseFeeVaultDeploymentBytecode).String(), hexutil.Bytes(deployBaseFeeVault.Data()).String())
	...
	require.Equal(t, hexutil.Bytes(l1FeeVaultDeploymentBytecode).String(), hexutil.Bytes(deployL1FeeVault.Data()).String())
	...
	require.Equal(t, hexutil.Bytes(sequencerFeeVaultDeploymentBytecode).String(), hexutil.Bytes(deploySequencerFeeVault.Data()).String())
